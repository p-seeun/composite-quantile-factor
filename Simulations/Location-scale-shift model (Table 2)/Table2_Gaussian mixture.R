#Location-scale-shift model: Gaussian mixture
...
Table2_mixgauss = matrix(nrow=7, ncol=0)
for(n in 1:5){
  table = rbind(RobPCA[[n]], QFM0.1[[n]], QFM0.3[[n]], QFM0.5[[n]], QFM0.7[[n]], QFM0.9[[n]], Huang[[n]], DAFM[[n]])
  Table2_mixgauss = cbind(Table2_mixgauss, table)
}

Table2_mixgauss # third table in Table 2
